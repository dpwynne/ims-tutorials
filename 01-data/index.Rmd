...
* Load and view a dataset in <a href="https://rguroo.com/">Rguroo</a> and distinguish between various variable types.
...
* Load data from the textbook companion Rguroo Dataset Repository
* Introduce data frames and how to navigate datasets ???
* Discuss variable types connecting terminology from textbook to <a href="https://rguroo.com/">Rguroo</a>
* Convert data types
...
* Define Simpson's paradox in a 2 cat var case
  * Use <a href="https://rguroo.com/">Rguroo</a> to make a contingency table
  * Group by third variable and make table again to demonstrate Simpson's paradox
...
* Use <a href="https://rguroo.com/">Rguroo</a> to obtain SRS and stratified sample
	* `slice_sample()`
...
* Use <a href="https://rguroo.com/">Rguroo</a> to do random assignment and random assignment after blocking
	* `slice_sample()` ???
	* `group_by()` %>% `slice_sample()` ???

### 4 - [Case study](https://openintro.shinyapps.io/ims-01-data-04/)

* Apply terminology, principles, and <a href="https://rguroo.com/">Rguroo</a> in this tutorial to a case study
